...
class CochePeritajeForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'ultimo_cambio_distribucion_fecha': forms.DateInput(format='%d-%m-%Y', attrs={'type': 'date','class': 'form-control', 'style': 'font-size: 13px !important;'}),
            ...
            'año': forms.TextInput(attrs={'class': 'form-control', 'onkeypress': 'return isNumber(event)',  'style': 'font-size: 13px !important;', 'maxlength':'4', 'placeholder': 'Ej.: 2022'}),
...
class InspeccionCubiertasForm(forms.ModelForm):
    class Meta:
        ...
        exclude = ['peritaje']
        widgets = {
            'marca_delantera_derecha': forms.Select(attrs={'class': 'form-control', 'style': 'font-size: 13px !important;'}),
            'marca_delantera_izquierda': forms.Select(attrs={'class': 'form-control','style': 'font-size: 13px !important;'}),
            'marca_trasera_derecha': forms.Select(attrs={'class': 'form-control','style': 'font-size: 13px !important;'}),
            'marca_trasera_izquierda': forms.Select(attrs={'class': 'form-control','style': 'font-size: 13px !important;'}),
            'marca_auxilio': forms.Select(attrs={'class': 'form-control','style': 'font-size: 13px !important;'}),
            ...
            'vida_util_auxilio': forms.TextInput(attrs={'class': 'form-control','id': 'id_vida_util_auxilio', 'placeholder': 'Ej. 87%','oninput':'updatePorcentajeVisualAuxilio(this.value)','style': 'font-size: 13px !important;'}),
            'vida_util_delantera_derecha': forms.TextInput(attrs={'class': 'form-control ','id': 'id_vida_util_delantera_derecha', 'placeholder': 'Ej. 87%','style': 'font-size: 13px !important;'}),
            'vida_util_delantera_izquierda': forms.TextInput(attrs={'class': 'form-control ','id': 'id_vida_util_delantera_izquierda', 'placeholder': 'Ej. 87%','style': 'font-size: 13px !important;'}),
            'vida_util_trasera_derecha': forms.TextInput(attrs={'class': 'form-control ','id': 'id_vida_util_trasera_derecha', 'placeholder': 'Ej. 87%','style': 'font-size: 13px !important;'}),
            'vida_util_trasera_izquierda': forms.TextInput(attrs={'class': 'form-control','id': 'id_vida_util_trasera_izquierda', 'placeholder': 'Ej. 87%','style': 'font-size: 13px !important;'}),
